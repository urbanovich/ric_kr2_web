 ...
 */
package study.web.document.helpers;

import study.web.document.entity.*;
import java.io.File;
...
public class Reader {
    ...
    public Reader() {
        try {
            ...
            URL xml = getClass().getClassLoader().getResource("study/web/document/resources/documents.xml");
            URL xsd = getClass().getClassLoader().getResource("study/web/document/resources/documents.xsd");
